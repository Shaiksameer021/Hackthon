    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      <div style={{ border: '1px solid rgba(16, 185, 129, 0.35)', borderRadius: 16, padding: 24, background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.07), rgba(6, 182, 212, 0.04))' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, flexWrap: 'wrap', gap: 10 }}>
          <h4 style={{ fontSize: 17, fontWeight: 800, color: '#FFF', display: 'flex', alignItems: 'center', gap: 8 }}>
            <span>🔄</span> What the AI Improved
          </h4>
        ...
        <p style={{ fontSize: 13, color: '#94A3B8', marginBottom: 18 }}>
          The Challenge Agent found weak areas. Here is exactly what changed and why:
        </p>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
          <h4 style={{ fontSize: 17, fontWeight: 800, color: '#FFF', display: 'flex', alignItems: 'center', gap: 8 }}>
            <span>📜</span> System Audit Trail & Decision Log
          </h4>
          <span className="badge badge-success" style={{ fontSize: 11 }}>
            Transparent Multi-Agent Rationale
          </span>
        </div>
...
export default function App() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      if (outcome.status === 'paused_for_clarification') {
        ...
        showToast('BrandMind system assembled with 100% causal self-correction!');
      }
    } catch (err) {
  ...
  const RenderModeBadge = ({ mode }) => {
    if (mode === 'live-gemini') {
      return (
        <span className="badge badge-gemini" title="Live Gemini 3.8 Flash API">
    ...
    if (mode === 'live-groq') {
      return (
        <span className="badge badge-groq" title="Live Groq Llama 3.3 API">
          <span style={{ width: 6, height: 6, borderRadius: '50%', backgroundColor: '#22D3EE' }}></span>
          Groq Llama 3.3
        </span>
      );
    }
    return (
      <span className="badge badge-fallback" title="Deterministic Idea-Aware Offline Generator">
  ...
  const STAGE_THEMES = {
    discover: {
      ...
      subtitle: 'Audience & Core Problem'
    },
    position: {
      color: '#8B5CF6',
      ...
      subtitle: 'Category & Value Proposition'
    },
    shape: {
      color: '#F59E0B',
      ...
      subtitle: 'Voice, Principles & Name'
    },
    visualize: {
      color: '#EC4899',
      ...
      subtitle: 'Palette, Fonts & Logo Mark'
    },
    challenge: {
      color: '#F43F5E',
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 10, padding: '2px 6px', borderRadius: 4, backgroundColor: 'rgba(99, 102, 241, 0.2)', color: '#A5B4FC', fontWeight: 600 }}>
                  AI
                </span>
              </div>
              <p style={{ fontSize: 11, color: '#94A3B8', lineHeight: 1.1 }}>
                Instant Brand Builder • Self-Correcting AI
              </p>
            </div>
          </div>
          ...
          >
            ...
            <span style={{ fontSize: 12, color: '#CBD5E1', fontWeight: 500 }}>
              Inkloom Hackathon • Code: <strong style={{ color: '#A5B4FC', fontFamily: 'var(--font-mono)' }}>INKLOOM-HACK-2026</strong>
            </span>
          </div>
      ...
      <main style={{ flex: 1, maxWidth: 1240, width: '100%', margin: '0 auto', padding: '36px 24px 60px' }}>
        ...
        <section style={{ textAlign: 'center', maxWidth: 840, margin: '0 auto 40px' }}>
          ...
          >
            <span>⚡</span>
            <span>6 Autonomous AI Agents That Design, Critique & Perfect Your Brand</span>
          </div>
          ...
          <p style={{ fontSize: 16, color: '#94A3B8', lineHeight: 1.6, marginBottom: 28, maxWidth: 680, margin: '0 auto 28px' }}>
            No fluffy textbook words. BrandMind turns your rough idea into a catchy name, punchy tagline, visual colors, and a launch-ready landing page — with <strong>AI self-correction you can actually see</strong>.
          </p>
          ...
          <div className="glass-panel glow-card" style={{ padding: 26, textAlign: 'left', position: 'relative' }}>
            <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 13, fontWeight: 700, color: '#CBD5E1', marginBottom: 10 }}>
              ...
              <span style={{ fontSize: 11, color: '#64748B', fontWeight: 500 }}>Plain English • Any Domain</span>
            </label>
            ...
            <textarea
              ...
              placeholder="Describe ANY idea (app, SaaS, local service, physical product, healthcare, food business, education)... e.g. 'A community repair hub where neighbors share specialized tools and teach each other how to fix appliances' or 'A mobile app that helps busy parents plan quick 15-minute healthy dinners'..."
              disabled={isRunning}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                ...
                {ideaInput.trim().length === 0 ? (
                  ...
                  <span style={{ color: '#FCD34D', display: 'flex', alignItems: 'center', gap: 4 }}>
                    <span>ℹ️</span> Very short idea (&lt;9 words) — Discover Agent will offer diagnostic clarification
                  </span>
                ) : (
                  <span style={{ color: '#34D399', display: 'flex', alignItems: 'center', gap: 4 }}>
                    <span>✅</span> Ready for Gemini semantic ingestion &amp; 6-agent chain
                  </span>
                )}
              </div>
            ...
            <div style={{ marginTop: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 14 }}>
              <div style={{ fontSize: 12, color: '#94A3B8' }}>
                <span style={{ color: '#A5B4FC' }}>
                  Architecture: Validation ➔ Gemini Semantic Blueprint ➔ 6 Autonomous Agents
                </span>
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 700, color: '#FFFFFF' }}>
                  {progressMsg || 'Running autonomous pipeline...'}
                </span>
              </div>
        ...
        {clarificationData && (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 13, color: '#CBD5E1' }}>
                  Your idea is short and punchy. The Discover Agent flagged 2 fast questions to help make your brand even better:
                </p>
              </div>
            </div>
            ...
            <input
              ...
              placeholder="Your answer (or leave empty to let AI decide autonomously)..."
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
              ...
              >
                Proceed Autonomously (Let AI Choose)
              </button>
              <button
                type="button"
                className="btn btn-primary"
          ...
          <div>
                  ...
                  <div className="score-hero-info">
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: 13, color: '#94A3B8', fontWeight: 500 }}>
                        Autonomous Idea Viability & Launch Readiness
                      </span>
                    </div>
            ...
            <div className="stages-flow-wrapper">
              ...
              <div className="stages-flow-header">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span style={{ fontSize: 12, color: '#94A3B8' }}>Sequential Flow:</span>
                  <span style={{
                    fontSize: 12,
                        ...
                        >
                          <div className="stage-card-top">
                            ...
                            {mode && (
                              ...
                              >
                                {mode === 'live-gemini' ? 'Gemini' : mode === 'live-groq' ? 'Groq' : 'Offline'}
                              </span>
                            )}
                          </div>
            ...
            <div className="glass-panel" style={{ padding: 28, minHeight: 480 }}>
              ...
              >
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <h2 style={{ fontSize: 24, fontWeight: 800 }}>
                      {activeTab === 'challenge' ? 'Challenge Agent: The AI Bullshit Detector' :
                       activeTab === 'deliver' ? 'Deliver Agent: The Finished Brand & Causal Proof' :
                       `${STAGES.find(s => s.id === activeTab)?.name} Agent Output`}
                    </h2>
                  </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <span style={{ fontSize: 12, color: '#64748B' }}>Engine:</span>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20 }}>
                    ...
                    <div className="glass-panel-elevated">
                      <h4 style={{ fontSize: 14, color: '#A5B4FC', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
                        <span>🧠</span> What the AI Discovered
                      </h4>
              ...
              {activeTab === 'challenge' && context.challenge && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                  ...
                  >
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                        ...
                        <span className="badge badge-danger">Autonomous Filter Active</span>
                      </div>
                      <p style={{ fontSize: 14, color: '#CBD5E1', maxWidth: 780 }}>
                        Most AI generators create boring, robotic text. The Challenge Agent tests earlier drafts against real-world customer expectations, flags lazy buzzwords, and mandates concrete improvements.
                      </p>
                    </div>
                  ...
                  <div>
                    <div style={{ marginBottom: 16 }}>
                      ...
                      <p style={{ fontSize: 13, color: '#94A3B8' }}>
                        Why this stage exists and how it protects your brand from looking like generic AI output.
                      </p>
                    </div>
                    ...
                    <div className="challenge-four-grid">
                      ...
                      <div className="challenge-question-card card-theme-system">
                        <div>
                          ...
                          <p className="challenge-card-answer">
                            Our Challenge Agent conducts <strong>4 automated health checks</strong>, catches every weak sentence, and passes mandatory rewrites straight to the Deliver Agent.
                          </p>
                        </div>
                        <div className="challenge-card-pill" style={{ borderColor: 'rgba(16, 185, 129, 0.3)' }}>
                          ...
                          <span style={{ color: '#ECFDF5' }}>
                            Zero clichés reach final launch. Deliver agent is required to enforce every fix.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 13, color: '#94A3B8', marginBottom: 18 }}>
                      Every critique follows our 4-pillar review standard: Problem, Why It Matters, Recommended Change, and the exact Improved Version handed to Deliver.
                    </p>
              ...
              {/* TAB 06: DELIVER (THE CAUSAL CLIMAX & BRAND KIT) */}
              ...
              {activeTab === 'deliver_DISABLED' && context.deliver && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                  ...
                  {/* CAUSAL BEFORE -> AFTER CENTERPIECE */}
                  <div
                    style={{
                  ...
                  >
                    ...
                    <p style={{ fontSize: 14, color: '#CBD5E1', marginBottom: 20 }}>
                      See how the Deliver Agent took the boring, generic draft and turned it into an active, punchy promise:
                    </p>
                        ...
                        <div className="audit-story-step">
                          ...
                          <div className="audit-story-content">
                            ...
                            <div className="audit-story-grid">
                              ...
                              <div className="audit-info-item">
                                <div className="audit-info-label">Decision Made</div>
                                <div>Flagged generic draft tagline and passive headlines; generated {context.deliver.correctionsAppliedSummary?.length || 3} mandatory causal corrections.</div>
                              </div>
                              <div className="audit-info-item">
                                <div className="audit-info-label">Why This Decision</div>
                        ...
                        <div className="audit-story-step">
                          ...
                          <div className="audit-story-content">
                            ...
                            <div className="audit-story-grid">
                              <div className="audit-info-item">
                                <div className="audit-info-label">What We Checked</div>
                                <div>Verified that every single issue caught by the Challenge Agent was completely rewritten.</div>
                              </div>
                              <div className="audit-info-item">
                                <div className="audit-info-label">Decision Made</div>
      ...
      >
        ...
        >
          <div>
            <strong>BrandMind</strong> • Inkloom Hackathon 2026 • Autonomous Self-Correcting AI
          </div>
          <div>
        ...
        <div className="modal-backdrop" onClick={() => setShowArchModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, fontSize: 14, color: '#CBD5E1' }}>
              <p>
                Most AI tools just spit out one answer. BrandMind uses <strong>six specialized AI agents</strong> that check each other’s work:
              </p>
              ...
              <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)', padding: 16, borderRadius: 10, border: '1px solid var(--border-subtle)' }}>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 12, color: '#06B6D4', marginBottom: 8, fontWeight: 700 }}>
                  THE 6 STAGES & THE SELF-CORRECTION LOOP
                </div>
              ...
              <div>
                <h4 style={{ fontSize: 15, color: '#FFF', marginBottom: 6 }}>The 4 Health Checks (Challenge Agent)</h4>
